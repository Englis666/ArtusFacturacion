                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex align-item-center justify-content-center">
                                    <h6 class="mb-0 font-weight-bold text-primary">Gastos por producto</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex align-item-center justify-content-center">
                                    <h6 class="mb-0 font-weight-bold text-primary">Gastos por Categoria De Producto</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table tabler-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Stock de Productos Por Categoria</h6>
                                </div>
                                <div class="card-body">
