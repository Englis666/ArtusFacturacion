            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/generarReporteGanancias" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex align-item-center justify-content-center">
                                    <h6 class="mb-0  text-primary">Ganancia por producto</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex align-item-center justify-content-center">
                                    <h6 class="mb-0  text-primary">Ganancia por Categoria De Producto</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table tabler-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
